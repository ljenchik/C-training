...
int main()
{
  ...
  if ((client_socket_3 = socket(AF_INET, SOCK_STREAM, 0)) == -1)
  {
  ...
  // Connect to server
  if (connect(client_socket_3, (struct sockaddr *)&server_address, sizeof(server_address)) == -1)
  {
